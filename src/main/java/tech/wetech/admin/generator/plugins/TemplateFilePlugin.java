...
import tech.wetech.admin.generator.file.GenerateByListTemplateFile;
import tech.wetech.admin.generator.file.GenerateByTemplateFile;
import tech.wetech.admin.generator.formatter.ListTemplateFormatter;
import tech.wetech.admin.generator.formatter.TemplateFormatter;
import tech.wetech.admin.generator.model.TableClass;
import tech.wetech.admin.generator.model.TableColumnBuilder;
...
public class TemplateFilePlugin extends PluginAdapter {
     ...
     * 默认的模板格式化类
     */
    public static final String DEFAULT_TEMPLATEFORMATTER = "tech.wetech.admin.generator.formatter.FreemarkerTemplateFormatter";
    /**
     * 单个文件模式
     */
