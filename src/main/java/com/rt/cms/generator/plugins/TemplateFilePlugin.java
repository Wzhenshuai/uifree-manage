...
import com.rt.cms.generator.file.GenerateByTemplateFile;
import com.rt.cms.generator.formatter.ListTemplateFormatter;
import com.rt.cms.generator.formatter.TemplateFormatter;
import com.rt.cms.generator.model.TableClass;
import com.rt.cms.generator.model.TableColumnBuilder;
...
import com.rt.cms.generator.file.GenerateByListTemplateFile;
...
public class TemplateFilePlugin extends PluginAdapter {
     ...
     * 默认的模板格式化类
     */
    public static final String DEFAULT_TEMPLATEFORMATTER = "FreemarkerTemplateFormatter";
    /**
     * 单个文件模式
     */
