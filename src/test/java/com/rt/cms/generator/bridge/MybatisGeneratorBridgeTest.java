package com.rt.cms.generator.bridge;

import org.apache.commons.io.FileUtils;
import org.apache.commons.io.FilenameUtils;
import org.junit.Test;
import com.rt.cms.generator.model.GeneratorConfig;
...
public class MybatisGeneratorBridgeTest{
    ...
    public void testGenerate() throws Exception {
        ...
        generatorConfig.setModelPackage("com.rt.cms.model");//实体类包名
        generatorConfig.setModelPackageTargetFolder("src/main/java");//实体类存放目录
        generatorConfig.setDaoPackage("com.rt.cms.mapper");//dao接口包名
